...
At Basta Fazoolin’ with my Heart our motto is simple:
when you’re here with family, that’s great! We have four different menus: brunch, early-bird, dinner, and kids.
...
"""
Create a Menu object and save it into the variable brunch.
Call it with the arguments "brunch" and the items dictionary in the code block above.
...
Test out Menu.calculate_bill(). We have a breakfast order for one order of pancakes, one order of home fries, and one coffee.
...
Give the Franchise class a constructor. Take in an address, and assign it to self.address.
...
Write a method .available_menus() that takes in two parameters, self and time.
It should iterate through all of self.menus and return only those menus that are available between start_time and end_time.
17.
...
Congrats! You created a system of classes that help structure your code and perform all business requirements you need.
